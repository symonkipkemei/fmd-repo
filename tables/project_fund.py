...
def update_table(project_source_id,project_fund_id):
    if project_source_id == 2:
        project_fund = algos.project_fund("project_fund",usd = False)

    else:
        project_fund = algos.project_fund("project_fund",usd = True)
...
def insert_table(project_source_id):
    ...
    if project_source_id == 2: # allow the user to input the amount set aside for the project
        project_fund = algos.project_fund("project_fund",usd = False)
    else:
        project_fund = algos.project_fund("project_fund",usd = True)
...
if __name__ == "__main__":
    result, result1 = retrieve_project_company_salaries_fund(2)
    print(result1)
